 ...
 * @param <T>
 */
public class QueuePriority<T extends Comparable<T>> implements Iterable<T> {
    ...
    public <Status extends Comparable<T>> QueuePriority(final Comparator<T> c) {
    ...
    /**
     * Obtiene un elemento idéntico si existe. Puede que el elemento devuelto
     * tenga una prioridad distinta.
     *
